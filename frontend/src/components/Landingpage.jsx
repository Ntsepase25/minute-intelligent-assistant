import dashboardImage from "../assets/mia-dashboard.jpeg";
    ...
    <div className="font-['Inter'] bg-gray-50 text-gray-800">
      ...
      <header className="sticky top-0 z-10 bg-white shadow-md">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          <div className="text-2xl uppercase tracking-widest font-extrabold text-indigo-600">
            MIA
          </div>
          ...
          {isPending ? (
            <div className="inline-flex items-center justify-center gap-2 [&amp;_svg:not([className*='size-'])]:size-4 shrink-0 [&amp;_svg]:shrink-0 focus-visible:border-ring aria-invalid:border-destructive h-9 px-4 py-2 has-[>svg]:px-3">
              <a>
                <Skeleton className="w-[92px] h-[34px] max-w-full" />
              </a>
            </div>
          ) : !session || !session.user ? (
            <Link
              to="/sign-in"
              className="px-4 py-2 bg-white border border-indigo-600 text-indigo-600 font-semibold rounded-full hover:bg-indigo-50 transition text-sm"
            >
              Sign In
            </Link>
          ) : (
      ...
      <main>
        ...
        <section className="py-16 md:py-24 text-center bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <p className="text-xl font-semibold uppercase tracking-widest text-indigo-600 mb-3">
            ...
            <p className="text-lg md:text-xl text-gray-600 mb-10 max-w-2xl mx-auto">
              MIA is the <strong>Minute Intelligent Assistant</strong> that
              makes recording and summarizing meeting minutes effortless.
            </p>
          </div>

          <div className="mt-16 lg:mx-24 md:mx-16 mx-6">
            <img
              src={dashboardImage}
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">
                Tired of the{" "}
                <span className="text-indigo-600">Information Overload?</span>
              </h2>
              <p className="text-xl text-gray-600 mb-8">
                Meetings shouldn't drain your productivity. You need an
                assistant that records, summarizes, and organizes your minutes
                automatically.
              </p>
            </div>
            <div className="space-y-6">
              <div className="p-6 bg-white rounded-xl shadow-lg border border-red-100">
                ...
                <p className="text-gray-600">
                  Wasting hours manually recording and summarizing meeting
                  minutes, trying to capture every key point. Important insights
              ...
              <div className="p-6 bg-white rounded-xl shadow-lg border border-indigo-300">
                ...
                <p className="text-gray-600">
                  Upload recordings or take live notes. MIA automatically
                  generates accurate, concise meeting minutes so your team stays
        ...
        <section id="features" className="py-16 md:py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-lg text-gray-600 mb-12">
              MIA streamlines your workflow, making meetings more effective and
              actionable.
            </p>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="p-6 bg-white rounded-2xl shadow-lg border border-gray-100 transition duration-300 hover:shadow-xl hover:border-indigo-300">
                ...
                <p className="text-gray-600">
                  Each summary is backed by the original transcript or
                  recording.
                </p>
              </div>
              <div className="p-6 bg-white rounded-2xl shadow-lg border border-gray-100 transition duration-300 hover:shadow-xl hover:border-indigo-300">
              ...
              <div className="p-6 bg-white rounded-2xl shadow-lg border border-gray-100 transition duration-300 hover:shadow-xl hover:border-indigo-300">
                ...
                <p className="text-gray-600">
                  Identifies key decisions, action items, and follow-ups
                  automatically.
                </p>
              </div>
            </div>
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <blockquote className="bg-white text-gray-800 p-8 md:p-12 rounded-2xl shadow-2xl relative">
              <p className="text-2xl md:text-3xl italic font-medium leading-relaxed">
                "Before MIA, our team struggled with keeping meeting notes. Now,
                minutes are instantly generated and accurate.{" "}
        ...
        <section id="use-cases" className="py-16 md:py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-4xl font-extrabold text-center mb-4">
              How MIA Transforms Meetings
            </h2>
            <p className="text-lg text-gray-600 text-center mb-12">
              Perfect for any professional looking to save time and capture key
              insights.
            </p>
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="p-8 bg-gray-50 rounded-2xl shadow-md border border-gray-200">
                ...
                <p className="text-gray-600 mb-4">
                  Summarize meetings and extract actionable points for
                  campaigns.
                </p>
              </div>
              <div className="p-8 bg-gray-50 rounded-2xl shadow-md border border-gray-200">
        ...
        {/* Final CTA Section */}
        <section
          className="py-16 md:py-24 bg-purple-500 text-center text-white"
          id="pricing"
        >
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-xl text-gray-100 mb-10">
              Let MIA handle the recording and summarization. Spend your meeting
              time effectively.
            </p>
          </div>
        </section>
